...
def train(priordataloader_class, criterion, encoder_generator, emsize=200, nhid=200, nlayers=6, nhead=2, dropout=0.0,
          ...
          initializer=None, initialize_with_model=None, train_mixed_precision=False, efficient_eval_masking=True, model_maker=False, output_attention=False, special_token=False, **model_extra_args
          ):
    ...
    if model_maker == "mlp":
        model = TransformerModelMakeMLP(encoder, n_out, emsize, nhead, nhid, nlayers, dropout, style_encoder=style_encoder,
                                ...
                                decoder=decoder, init_method=initializer, efficient_eval_masking=efficient_eval_masking, output_attention=output_attention, special_token=special_token, **model_extra_args
                                )
    elif model_maker:
