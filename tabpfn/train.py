...
def train(priordataloader_class, criterion, encoder_generator, emsize=200, nhid=200, nlayers=6, nhead=2, dropout=0.0,
          ...
          special_token=False, predicted_hidden_layer_size=None, decoder_embed_dim=2048, **model_extra_args
          ):
    ...
    if model_maker == "mlp":
        model = TransformerModelMakeMLP(encoder, n_out, emsize, nhead, nhid, nlayers, dropout, style_encoder=style_encoder,
                                ...
                                predicted_hidden_layer_size=predicted_hidden_layer_size, decoder_embed_dim=decoder_embed_dim, **model_extra_args
                                )
    elif model_maker:
