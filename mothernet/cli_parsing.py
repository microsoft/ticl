...
def argparser_from_config(parser, description="Train Mothernet"):
    ...
    if 'transformer' in config:
        ...
        transformer.add_argument('--flex-attn-sliding-window-size', type = int, help = 'sliding window size for flex attention')
    ...
    orchestration.add_argument('--no-mlflow', help="whether to use mlflow", type=str2bool, default=True)
